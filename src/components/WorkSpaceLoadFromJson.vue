...
export default {
  ...
  methods: {
    ...
    convertToNewVersion: function(obj) {
      ...
      this.translation_obj.novel_title = obj.novel_title;
      this.translation_obj.novel_volume = obj.novel_volume;
      this.translation_obj.novel_chapter = obj.novel_chapter;
      this.translation_obj.novel_content = [];
      obj.novel_content.forEach(item => {
